...
SeasideImageLabel::SeasideImageLabel(MWidget *parent): MStylableWidget(parent)
{
...
SeasideImageLabel::~SeasideImageLabel()
{
}

void SeasideImageLabel::setText(const QString &text)
{
    m_text = text;
}

void SeasideImageLabel::applyStyle()
{
